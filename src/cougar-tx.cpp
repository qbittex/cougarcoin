...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("cougar Core cougar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cougar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cougar transaction") + "\n" +
                               "  cougar-tx [options] -create [commands]   " + _("Create hex-encoded cougar transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cougar transaction

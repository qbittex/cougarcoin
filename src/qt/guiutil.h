...
/** Utility functions used by the cougar Qt UI.
 */
namespace GUIUtil
{
...
// Render cougar addresses in monospace font
...
// Parse "cougar:" URI into recipient object, return true on successful parsing

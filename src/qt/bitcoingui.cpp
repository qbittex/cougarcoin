...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cougar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cougar:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About cougar Core"), this);
    aboutAction->setStatusTip(tr("Show information about cougar Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cougar"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cougar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cougar addresses"));
    ...
    openAction->setStatusTip(tr("Open a cougar:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the cougar Core help message to get a list with possible cougar command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("cougar Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cougar network", "", count));
}
...
{
    QString strTitle = tr("cougar"); // default title

...
RESOURCES += src/qt/cougar.qrc src/qt/cougar_locale.qrc

TRANSLATIONS += src/qt/locale/cougar_bg.ts \
                src/qt/locale/cougar_de.ts \
                src/qt/locale/cougar_en.ts \
                src/qt/locale/cougar_es.ts \
                src/qt/locale/cougar_fi.ts \
                src/qt/locale/cougar_fr.ts \
                src/qt/locale/cougar_it.ts \
                src/qt/locale/cougar_ja.ts \
                src/qt/locale/cougar_pl.ts \
                src/qt/locale/cougar_pt.ts \
                src/qt/locale/cougar_ru.ts \
                src/qt/locale/cougar_sk.ts \
                src/qt/locale/cougar_sv.ts \
                src/qt/locale/cougar_vi.ts \
                src/qt/locale/cougar_zh_CN.ts \
                src/qt/locale/cougar_zh_TW.ts
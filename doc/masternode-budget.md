...
cougar now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare <proposal-name> <url> <payment_count> <block_start> <cougar_address> <monthly_payment_xmx>
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CGR, _12_ times over the course of a year totaling _24000_ CGR.
...
mnbudget submit <proposal-name> <url> <payment_count> <block_start> <cougar_address> <monthly_payment_xmx> <collateral_hash>
...
When block `1000000` is reached you'll receive a payment for `1200` CGR.
 ...
 * vote-many          - Vote on a cougar initiative
 * vote-alias         - Vote on a cougar initiative
 * vote               - Vote on a cougar initiative/budget

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cougar features */
        {"cougar", "masternode", &masternode, true, true, false},
        {"cougar", "masternodelist", &masternodelist, true, true, false},
        {"cougar", "mnbudget", &mnbudget, true, true, false},
        {"cougar", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cougar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cougar", "mnsync", &mnsync, true, true, false},
        {"cougar", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cougar", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cougard, or the -server option to cougar-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cougar-cli " + methodname + " " + args + "\n";
}

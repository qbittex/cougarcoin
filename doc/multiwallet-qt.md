...
In order to support loading of multiple wallets in cougar-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cougar.cpp.
...
Changes to cougar.cpp
-------------------

cougar.cpp is the entry point into cougar-qt, and as such, will require some minor modifications to provide hooks for
